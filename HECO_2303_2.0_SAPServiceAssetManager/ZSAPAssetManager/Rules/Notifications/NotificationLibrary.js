...
export default class {
    ...
    */
    ...
    static NotificationCreateMainWorkCenter(context) {
        //HECO does not use assignment 5 but still wants to select the value, unless its CIS. 
        //CIS leaves work center blank
    ...
    static NotificationCreateMainWorkCenterPlant(context) {
        //HECO does not use assignment 5 but still wants to select the value
        // if (libCom.getNotificationAssignmentType(context) === '5') {
    ...
    static NotificationCreateUpdateFunctionalLocationLstPkrValue(context) {
        //HECO Omni Get selected FuncLoc from the map
        let omniFuncLoc = libCom.getStateVariable(context, 'OmniSelectedFuncLoc')
        if(omniFuncLoc) {
            return omniFuncLoc;
        }
        //ENDHECO Omni
