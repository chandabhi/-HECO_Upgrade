...
export class BusinessPartnerWrapper {
    ...
    address() {
        ...
        let ZHouseNum2 = this.entity?.Address_Nav?.ZHouseNum2;
        ...
        // Pushed house number along with address in line 1
        if (!libVal.evalIsEmpty(ZHouseNum2)) {
            line1.push(',');
            line1.push(' ');
            line1.push(ZHouseNum2);
        }
