...
import isTimeSheetsEnabled from '../../../../SAPAssetManager/Rules/TimeSheets/TimeSheetsIsEnabled';
import isConfirmationsEnabled from '../../../../SAPAssetManager/Rules/Confirmations/ConfirmationsIsEnabled';
import confirmationsCreateUpdateNav from '../../../../SAPAssetManager/Rules/Confirmations/CreateUpdate/ConfirmationCreateUpdateNav';
...
import UnconfirmOperationMobileStatusAction from '../../../../SAPAssetManager/Rules/Operations/MobileStatus/UnconfirmOperationMobileStatusAction';
import libClock from '../../../../SAPAssetManager/Rules/ClockInClockOut/ClockInClockOutLibrary';
import authorizedConfirmationCreate from '../../../../SAPAssetManager/Rules/UserAuthorizations/Confirmations/EnableConfirmationCreate';
import authorizedTimeSheetCreate from '../../../../SAPAssetManager/Rules/UserAuthorizations/TimeSheets/EnableTimeSheetCreate';
...
import libDigSig from '../../../../SAPAssetManager/Rules/DigitalSignature/DigitalSignatureLibrary';
import checkDeviceRegistration from '../../../../SAPAssetManager/Rules/DigitalSignature/CheckDeviceCreation';
...
import GenerateLocalConfirmationNumber from '../../../../SAPAssetManager/Rules/Confirmations/CreateUpdate/OnCommit/GenerateLocalConfirmationNum';
...
import EnableFieldServiceTechnician from '../../../../SAPAssetManager/Rules/SideDrawer/EnableFieldServiceTechnician';
...
export default class {
    ...
    static createBlankConfirmation(context, sOffset = 0) {
        ...
        //HECO Disable Final Confirmation for some order types
        if(context.binding.WOHeader&&(context.binding.WOHeader.OrderType == 'ED06'
        || context.binding.WOHeader.OrderType == 'TC01'
        || context.binding.WOHeader.OrderType == 'ZSMO'
        || context.binding.WOHeader.OrderType == 'ZMRO'
        ...
        return Promise.all([ConfirmationNum, ConfirmationCounter]).then((resolvedValues) => {
            ...
            return context.executeAction({'Name': '/SAPAssetManager/Actions/Confirmations/ConfirmationCreateBlank.action', 'Properties': {
                'Properties':
                {
                    ...
                    'FinalConfirmation': 'X',
                    'OrderID': binding.OrderId,
                    'Operation': binding.OperationNo||binding.Operations[0].OperationNo,
                    'SubOperation': binding.SubOperationNo || '',
                    'StartDate': currentDate,
                    'StartTime': currentTime,
                    'FinishDate': currentDate,
