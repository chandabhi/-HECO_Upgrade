...
export default function MeterReadingsUpdateNav(context) {
    ...
    },
    {
        ...
        },
        {
            ...
            'Caption': '$(L,reason)',
            'IsEditable': true,
            'Value': '/ZSAPAssetManager/Rules/Meter/HECO/ZCISMeterReadReason.js',
            'IsPickerDismissedOnSelection': true,
            'IsSearchCancelledAfterSelection': true,
    ...
    let meterDetails = {
        ...
        EquipId: context.binding.EquipmentNum,
        DateTime: new ODataDate()
    }
    //HECO Used for loading previous reading data on dynamic screens
    CommonLibrary.setStateVariable(context, 'ZDeviceDetails', meterDetails); 
    CommonLibrary.setStateVariable(context, 'ZNotifNum', binding.Workorder_Nav.NotificationNumber); 
    //HECO End
